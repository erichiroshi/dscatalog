package com.erichiroshi.msuser.resources;
...
import com.erichiroshi.msuser.services.UserService;
...
public class UserResource {
	...
	public ResponseEntity<User> findByEmailUser(@RequestParam String email) {
		User user = service.findByEmailUser(email);
